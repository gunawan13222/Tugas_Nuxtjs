<template>
  <Header></Header>
  <div>
    <section class="h-screen bg-gray-100 py-12 sm:py-16 lg:py-20 mt-0">
          ...
          <div class="rounded-3xl bg-white shadow-lg">
            <div class="px-4 py-6 sm:px-8 sm:py-10">
                ...
                <ul class="-my-8">
                  <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                    <div class="shrink-0 relative">
                      ...
                      <img
                        ...
                        src="https://7d6c0583.aerocdn.com/image-factory/95a0bc442e414ec485ac602fc55ee6231f786d20~480x480/images/products/kUlYTm2oG0bf8KRFHWObEzI5MEeOu6ojXxibjgaP.jpg"
                        alt=""
                      />
                    </div>
                  ...
                  <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                    <div class="shrink-0 relative">
                      ...
                      <img
                        class="h-24 w-24 max-w-full rounded-lg object-cover"
                        src="https://7d6c0583.aerocdn.com/image-factory/95a0bc442e414ec485ac602fc55ee6231f786d20~480x480/images/products/IvsBOntMTEfOwLB80ZxQs6lpILcaz1BTDypRbYL5.jpg"
                        alt=""
                      />
                    </div>
              ...
              <div class="mt-6 text-center">
                <button type="button" class="group inline-flex w-full items-center justify-center rounded-md bg-gray-800 px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-pink-500">
                  Place Order
